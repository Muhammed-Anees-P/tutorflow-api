...
- [ ] **Live chat & messaging** — real-time communication between students and tutors
- [ ] **Session rescheduling** — allow students to request a new session time, subject to tutor approval
